...
class AppointmentData {
  ...
  const AppointmentData({this.count, this.dayofWeek, this.appointmentDate});
  AppointmentData copyWith({int? count, String? dayofWeek, String? appointmentDate}) {
    return AppointmentData(count: count ?? this.count, dayofWeek: dayofWeek ?? this.dayofWeek, appointmentDate: appointmentDate ?? this.appointmentDate);
  }
...
class ClickData {
  ...
  ClickData copyWith({int? count, String? dayofWeek, String? clickDate}) {
    return ClickData(count: count ?? this.count, dayofWeek: dayofWeek ?? this.dayofWeek, clickDate: clickDate ?? this.clickDate);
  }
...
class Offer {
  ...
  const Offer({this.offersToday, this.offersMonth, this.offersTotal});
  Offer copyWith({int? offersToday, int? offersMonth, int? offersTotal}) {
    return Offer(offersToday: offersToday ?? this.offersToday, offersMonth: offersMonth ?? this.offersMonth, offersTotal: offersTotal ?? this.offersTotal);
  }
...
class Click {
  ...
  Click copyWith({int? clicksToday, int? clicksMonth, int? clicksTotal}) {
    return Click(clicksToday: clicksToday ?? this.clicksToday, clicksMonth: clicksMonth ?? this.clicksMonth, clicksTotal: clicksTotal ?? this.clicksTotal);
  }
